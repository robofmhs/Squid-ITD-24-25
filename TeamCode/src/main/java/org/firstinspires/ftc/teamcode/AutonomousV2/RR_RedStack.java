...
@Autonomous(name="RR_RedStack", group="Linear OpMode")
public class RR_RedStack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new RR_RedStack.samplePipeline());
...
//    }
    ...
    private TrajectorySequence getRedBoardLeft(SampleMecanumDrive drive, Pose2d startPose) {
        return drive.trajectorySequenceBuilder(startPose)
//                .forward(.25)
                .splineTo(new Vector2d(-50,-45),Math.toRadians(90))
                .UNSTABLE_addTemporalMarkerOffset(-.2,()->drop.setPosition(.5))
//                .back(1)
//                .back(2)
                .waitSeconds(1.5)
                .back(4)
                .splineToConstantHeading(new Vector2d(-44,-60),Math.toRadians(-90))
                .forward(2)
