...
@Autonomous(name="RR_RedBoard2+2", group="Linear OpMode")
public class RR_RedBoard2_2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new RR_RedBoard2_2.samplePipeline());
