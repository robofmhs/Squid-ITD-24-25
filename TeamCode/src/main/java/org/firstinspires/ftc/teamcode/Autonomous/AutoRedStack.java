...
//                    base.guard.setPosition(1);
                    ...
                    sleep(2000);
                    encoderDrive(BACKWARD,DRIVE_SPEED,20,20,500);
                    sleep(2000);
                    encoderDrive(RIGHTSLIDE,DRIVE_SPEED,90,90,500);
                    sleep(2000);
                    ...
                    wrist.setPosition(.878333333334);
                    sleep(2000);
                    encoderDrive(BACKWARD,DRIVE_SPEED,8.5,8.5,500);
                    sleep(2000);
                    guard.setPosition(.2);
                    sleep(1000);
                    arm.setVelocity(3000);
...
//                    base.guard.setPosition(1);
                    ...
                    wrist.setPosition(.878333333334);
                    sleep(2000);
                    encoderDrive(BACKWARD,DRIVE_SPEED,3.5,3.5,500);
                    sleep(1000);
                    guard.setPosition(.2);
                    sleep(1000);
                    guard.setPosition(.2);
