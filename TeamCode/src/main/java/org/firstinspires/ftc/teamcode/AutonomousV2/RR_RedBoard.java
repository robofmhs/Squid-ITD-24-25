...
import org.firstinspires.ftc.teamcode.AutonomousV1.Cam2;
...
import org.firstinspires.ftc.robotcore.external.hardware.camera.WebcamName;
import org.firstinspires.ftc.teamcode.AutonomousV1.AutoRedBoard;
...
@Autonomous(name="RR_RedBoard", group="Linear OpMode")
public class RR_RedBoard extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new RR_RedBoard.samplePipeline());
...
//                .forward(.25)
                ...
                .back(2)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> drop.setPosition(.45))
                .waitSeconds(1.0)
...
//                .splineToConstantHeading(new Vector2d(0, -23), Math.toRadians(180))
//                .UNSTABLE_addTemporalMarkerOffset(-3, this::resetArmPos)
//                .splineToConstantHeading(new Vector2d(-54, -20), Math.toRadians(180))//go to stack
//                .strafeLeft(1)
//                .waitSeconds(2.0)
//                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> stack.setPosition(1))
//                .UNSTABLE_addTemporalMarkerOffset(0, () -> intake.setPower(1.0))
...
//                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(49, 49, 15.99))
//                .back(3)
//                .splineToConstantHeading(new Vector2d(-10, -19), Math.toRadians(180))
//                .splineToConstantHeading(new Vector2d(4, -19), Math.toRadians(180))
//                .UNSTABLE_addTemporalMarkerOffset(+2, () -> setArmPos(500, 3000))
...
//                .splineToConstantHeading(new Vector2d(0, -23), Math.toRadians(180))
//                .UNSTABLE_addTemporalMarkerOffset(-3, this::resetArmPos)
//                .splineToConstantHeading(new Vector2d(-55, -20), Math.toRadians(180))//go to stack
//                .waitSeconds(2.0)
//                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> stack.setPosition(1))
//                .UNSTABLE_addTemporalMarkerOffset(0, () -> intake.setPower(1.0))
//                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(4, 4, 15.99))
//                .strafeLeft(3)//                .waitSeconds(1.0)
//                .UNSTABLE_addTemporalMarkerOffset(0, () -> setArmPos(-25, 3000))
////                .waitSeconds(.5)
//                .forward(6)
////                .UNSTABLE_addTemporalMarkerOffset(-.10,()->intake.setPower(0.5))
...
//                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(49, 49, 15.99))
//                .back(3)
//                .splineToConstantHeading(new Vector2d(4, -20), Math.toRadians(180))
//                .UNSTABLE_addTemporalMarkerOffset(+2, () -> setArmPos(500, 3000))
//                .splineToConstantHeading(new Vector2d(20, -20), Math.toRadians(180))
//                .splineToConstantHeading(new Vector2d(35, -35), Math.toRadians(180))
//                .back(7)
...
//                .waitSeconds(20)
    ...
    private TrajectorySequence getRedBoardRight(SampleMecanumDrive drive, Pose2d startPose) {
        return drive.trajectorySequenceBuilder(startPose)
                .splineTo(new Vector2d(36, -32), Math.toRadians(180))//DROP Purple
                .UNSTABLE_addTemporalMarkerOffset(0, () -> drop.setPosition(.4))// move drop servo
                .waitSeconds(1.0)
                .splineToConstantHeading(new Vector2d(52, -36), Math.toRadians(180))//drop yellow
                .back(4)
                .UNSTABLE_addTemporalMarkerOffset(0, this::dropArmPos)//set arm pos for yellow drop
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(40, 40, 15.99))
...
//                .waitSeconds(2)
//                .splineToConstantHeading(new Vector2d(33, -23), Math.toRadians(180))//set for trvalling through middle
//                .splineToConstantHeading(new Vector2d(0, -23), Math.toRadians(180))//go to middle
//                .UNSTABLE_addTemporalMarkerOffset(-3, this::resetArmPos)//lower viper
//                .splineToConstantHeading(new Vector2d(-55, -22), Math.toRadians(180))//go to stack
//                .waitSeconds(1.5)
//                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> stack.setPosition(1))//knock over pixels
//                .UNSTABLE_addTemporalMarkerOffset(0, () -> intake.setPower(1.0))//turn on intake
//                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(4, 4, 15.99))//slow down base movement
//                .strafeLeft(3.2)//align with pixel stack
//                .UNSTABLE_addTemporalMarkerOffset(0, () -> setArmPos(-25, 3000))//lower viper to ground
////                .waitSeconds(.5)
//                .forward(6)
////                .UNSTABLE_addTemporalMarkerOffset(-.10,()->intake.setPower(0.5))
//                .UNSTABLE_addTemporalMarkerOffset(+1, () -> setArmPos(150, 500))
...
//                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(49, 49, 15.99))
//                .back(7)
//                .splineToConstantHeading(new Vector2d(-42, -17.5), Math.toRadians(180))//go to stack
//                .splineToConstantHeading(new Vector2d(4, -21), Math.toRadians(180))
//                .UNSTABLE_addTemporalMarkerOffset(+2, () -> setArmPos(500, 3000))
//                .splineToConstantHeading(new Vector2d(20, -21), Math.toRadians(180))
//                .splineToConstantHeading(new Vector2d(35, -35), Math.toRadians(180))
//                .back(5)
//                .UNSTABLE_addTemporalMarkerOffset(+1, this::dropArmPos2)
//                .waitSeconds(20)
