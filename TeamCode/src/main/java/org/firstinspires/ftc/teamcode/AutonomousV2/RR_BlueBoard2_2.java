...
@Autonomous(name="RR_BlueBoard2+2", group="Linear OpMode")
public class RR_BlueBoard2_2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new RR_BlueBoard2_2.samplePipeline());
        ...
        int count=0;
        Pose2d startPose = new Pose2d(12, (70 - 9), Math.toRadians(-90));
...
//    }
    ...
    private TrajectorySequence getRedBoardLeft(SampleMecanumDrive drive, Pose2d startPose) {
        return drive.trajectorySequenceBuilder(startPose)
//                .forward(.25)
                .splineTo(new Vector2d(35, 27), Math.toRadians(180))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> drop.setPosition(.4))
                .waitSeconds(.75)
                .splineToConstantHeading(new Vector2d(52, 32), Math.toRadians(180))
                .back(5)
                .UNSTABLE_addTemporalMarkerOffset(0, this::dropArmPos)
                .waitSeconds(1.8)
//                .forward(6)
...
//                .waitSeconds(20)
                ...
                .splineToConstantHeading(new Vector2d(0, 14), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(-15, 14), Math.toRadians(180))
                .UNSTABLE_addTemporalMarkerOffset(-3, this::resetArmPos)
                .splineToConstantHeading(new Vector2d(-55, 22.5), Math.toRadians(180))
//                .strafeRight(1)
                .waitSeconds(1.50)
                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> stack.setPosition(1))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> intake.setPower(1.0))
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(9, 9, 15.99))
                .strafeLeft(3)//                .waitSeconds(1.0)0
                .UNSTABLE_addTemporalMarkerOffset(0, () -> setArmPos(-50, 3000))
                .forward(6)
                .waitSeconds(.4)
//                .UNSTABLE_addTemporalMarkerOffset(-.10,()->intake.setPower(0.5))
                .UNSTABLE_addTemporalMarkerOffset(+1.2, () -> setArmPos(150, 500))
                .UNSTABLE_addTemporalMarkerOffset(+1.2, () -> wrist.setPosition(.20))
                .UNSTABLE_addTemporalMarkerOffset(+1.4, () -> intake.setPower(0))
                .UNSTABLE_addTemporalMarkerOffset(+1.5, () -> guard.setPosition(.7))
                .UNSTABLE_addTemporalMarkerOffset(+1.5, () -> wrist.setPosition(.46))
                .waitSeconds(1.8)
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(40, 40, 15.99))
                .back(7)
//                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(49, 49, 15.99))
                .splineToConstantHeading(new Vector2d(0, 20), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(23, 20), Math.toRadians(180))
//                .back(10)
                .UNSTABLE_addTemporalMarkerOffset(+2, () -> setArmPos(500, 3000))
                .splineToConstantHeading(new Vector2d(37, 29), Math.toRadians(180))
                .back(9)
                .UNSTABLE_addTemporalMarkerOffset(+.75, this::dropArmPos2)
                .waitSeconds(20)
                .build();
    }
    private TrajectorySequence getRedBoardCenter(SampleMecanumDrive drive, Pose2d startPose) {
        return drive.trajectorySequenceBuilder(startPose)
//                .forward(.25)
                .splineTo(new Vector2d(29, 19), Math.toRadians(180))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> drop.setPosition(.4))
                .waitSeconds(.75)
                .splineToConstantHeading(new Vector2d(52, 25), Math.toRadians(180))
                .back(5)
                .UNSTABLE_addTemporalMarkerOffset(0, this::dropArmPos)
                .waitSeconds(1.8)
                //                .waitSeconds(2)
...
//
                ...
                .splineToConstantHeading(new Vector2d(-15, 14), Math.toRadians(180))
                .UNSTABLE_addTemporalMarkerOffset(-3, this::resetArmPos)
                .splineToConstantHeading(new Vector2d(-55, 19), Math.toRadians(180))
//                .strafeRight(1)
                .waitSeconds(1.80)
                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> stack.setPosition(1))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> intake.setPower(1.0))
                ...
                .forward(6)
//                .UNSTABLE_addTemporalMarkerOffset(-.10,()->intake.setPower(0.5))
                .UNSTABLE_addTemporalMarkerOffset(+.8, () -> setArmPos(150, 500))
                .UNSTABLE_addTemporalMarkerOffset(+.8, () -> wrist.setPosition(.20))
                .UNSTABLE_addTemporalMarkerOffset(+.8, () -> intake.setPower(0))
                .UNSTABLE_addTemporalMarkerOffset(+1.5, () -> guard.setPosition(.7))
                .waitSeconds(1.8)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> wrist.setPosition(.46))
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(40, 40, 15.99))
                .back(7)
//                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(49, 49, 15.99))
                .splineToConstantHeading(new Vector2d(0, 17), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(23, 17), Math.toRadians(180))
//                .back(10)
                .UNSTABLE_addTemporalMarkerOffset(+2, () -> setArmPos(500, 3000))
    ...
    private TrajectorySequence getRedBoardRight(SampleMecanumDrive drive, Pose2d startPose) {
        return drive.trajectorySequenceBuilder(startPose)
                .splineTo(new Vector2d(11, 28), Math.toRadians(180))
                .UNSTABLE_addTemporalMarkerOffset(+0, () -> drop.setPosition(.5))
                .waitSeconds(.8)
//                .back(3)
                .splineToConstantHeading(new Vector2d(52, 28), Math.toRadians(180))
                .back(5)
                .UNSTABLE_addTemporalMarkerOffset(0, this::dropArmPos)
//                .waitSeconds(2)
//                .forward(5)
...
//                .waitSeconds(20)
                ...
                .forward(3)
//                .waitSeconds(.5)
                .splineToConstantHeading(new Vector2d(30, 21 ), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(0, 21), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(-15, 21), Math.toRadians(180))
                .UNSTABLE_addTemporalMarkerOffset(-3, this::resetArmPos)
                .splineToConstantHeading(new Vector2d(-55, 24), Math.toRadians(180))
//                .strafeLeft(1)
                .waitSeconds(1.8)
                .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> stack.setPosition(1))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> intake.setPower(1.0))
...
//                .UNSTABLE_addTemporalMarkerOffset(-.10,()->intake.setPower(0.5))
                ...
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(40, 40, 15.99))
                .back(7)
                .splineToConstantHeading(new Vector2d(4, 21), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(25, 21), Math.toRadians(180))
//                .back(10)
                .UNSTABLE_addTemporalMarkerOffset(+2, () -> setArmPos(500, 3000))
                .splineToConstantHeading(new Vector2d(36, 33), Math.toRadians(180))
                .back(5)
                .UNSTABLE_addTemporalMarkerOffset(+1, this::dropArmPos2)
                .waitSeconds(20)
                .build();
